  ...
  return (
    <section className="pb-[200px]">
      ...
      <div className="flex gap-10 flex-col items-center md:items-start md:flex-row">
        <div>
          <p>
            Hi there! My name is Matvei, and I'm thrilled to share a little bit
            about myself with you. I'm a web developer with a passion for
            creating beautiful and functional digital experiences. My journey in
            web development began in 2020, and since then, I've had the
            privilege of working with a diverse range of clients, from small
            businesses to larger corporations. Currently, I work as a
            freelancer, and I love the variety of projects that come my way.
            <br /> <br />
            ...
            where I honed my skills in building user-centric websites. I also
            ...
            <br /> <br />
            Overall, I'm a dedicated and passionate web developer who is
            committed to creating engaging, user-friendly experiences on the
        ...
        <div className="relative max-h-[300px] max-w-[300px] bg-cyan-300 rounded-md group">
          <Image
            src={profilePicture}
            alt="profile-image"
            className="rounded-md w-[100%] h-[100%] grayscale contrast-100 mix-blend-multiply hover:filter-none hover:mix-blend-normal object-cover"
          />
